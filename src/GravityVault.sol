 ...
 */
contract GravityVault is Ownable, ERC20Votes, ReentrancyGuard {
    ...
    constructor(IStrategy _strategy, string memory name, string memory symbol, uint256 _approvalDelay)
        ERC20Permit(name)
        ERC20(name, symbol)
    {
        strategy = _strategy;
